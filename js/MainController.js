app.controller('MainController', ($scope, $http, $sce) => {
	...
	$scope.pins = 	[	{	t: '7.0%', l: '32.65%',ip: 'images/floorplans/NSMD/NSMD 1ST FLR.png', 
						...
						{	t: '45.8%', l: '42.6%',
							pip: 'images/gallery/Oblation Square/ObleSquare.jpg', pf: [{Dloc:'images/gallery/Oblation Square/ObleSquare.jpg'}, {Dloc:'images/gallery/Oblation Square/ObleSquare.jpg'}, {Dloc:'images/gallery/Oblation Square/ObleSquare.jpg'}],
