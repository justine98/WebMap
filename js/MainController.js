app.controller('MainController', ($scope, $http) => {
	...
	$scope.description = ''
	$scope.photo = ''
	$scope.fps =  [{Ploc:'images/floorplans/AS/AS 1ST FLR LEFT.png', flr: 'L1'}, {Ploc:'images/floorplans/AS/AS 1ST FLR RIGHT.png', flr: 'R1'}, {Ploc:'images/floorplans/AS/AS 2ND FLR LEFT.png', flr: 'L2'}, {Ploc:'images/floorplans/AS/AS 2ND FLR RIGHT.png', flr: 'R2'}, {Ploc:'images/floorplans/AS/AS DCS 3RD FLR.png', flr: 'R3'}]
	$scope.pins = [	{t: '7.0%', l: '32.65%',ip: 'images/floorplans/NSMD/NSMD 1ST FLR.png', f: [{Ploc:'images/floorplans/NSMD/NSMD 1ST FLR.png', flr: 'F1'}, {Ploc:'images/floorplans/NSMD/NSMD 2ND FLR.png', flr: 'F2'}], Bldng: 'UNDERGRADUATE BUILDING', Dscr: 'The Undergraduate Building serves as the main building of the Arts and Humanities Cluster and Sciences Cluster. It is located at the western side of the UP Cebu Lahug Campus, near the basketball and volleyball courts.'},
					...
					{t: '35%', l: '26.43%', ip: 'images/floorplans/Management/MANAGEMENT BLDG 1.png', f: [{Ploc:'images/floorplans/Management/MANAGEMENT BLDG 1.png', flr: 'B1'}, {Ploc:'images/floorplans/Management/MANAGEMENT BLDG 2.png', flr: 'B2'}], Bldng: 'MANAGEMENT BUILDING', Dscr: 'The Management Building serves as the main building for Business Management Cluster. It is located at the western side of the UP Cebu Lahug Campus, beside the University Clinic.'},
					...
					{t: '22%', l: '67.8%', ip: 'images/floorplans/AS/AS 1ST FLR LEFT.png', f: [{Ploc:'images/floorplans/AS/AS 1ST FLR LEFT.png', flr: 'L1'}, {Ploc:'images/floorplans/AS/AS 1ST FLR RIGHT.png', flr: 'R1'}, {Ploc:'images/floorplans/AS/AS 2ND FLR LEFT.png', flr: 'L2'}, {Ploc:'images/floorplans/AS/AS 2ND FLR RIGHT.png', flr: 'R2'}, {Ploc:'images/floorplans/AS/AS DCS 3RD FLR.png', flr: 'R3'}], Bldng: 'ARTS and SCIENCES BUILDING', Dscr: 'The Arts and Sciences Building is located at the eastern side of the UP Cebu Lahug Campus near the parking lot. It is where the Computer Science, Business Management, and Physical Education department faculties and Office of the Social Sciences Cluster are situated. The UP Press Bookstore and AS Lobby are also found in this building.'},
